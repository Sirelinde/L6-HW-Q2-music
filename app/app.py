...
def hello_world():
    ...
    if request_type_str == 'GET':
        ...
        return render_template('index.html', href2='The recommended music for you (age: '+str(myage)+', gender: '+str(mygender)+', academic qualification: '+str(myquali)+') is: '+y_pred_to_str)
